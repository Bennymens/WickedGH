    ...
    return (
        <footer className="wg-footer">
            ...
            <div className="wg-footer-newsletter">
                ...
                <form className="wg-newsletter-form" onSubmit={e => e.preventDefault()}>
                    <input
                        className="wg-newsletter-input"
                        type="email"
                        placeholder="Your email address"
                    />
                    <button className="wg-newsletter-submit" type="submit">→</button>
                </form>
            </div>
            ...
            <div className="wg-footer-bottom">
                <p className="wg-footer-copy">© {new Date().getFullYear()} Wicked GH — Made in Ghana 🇬🇭</p>
